...
bool Engine::runInference(const std::vector<cv::Mat> &inputFaceChips, std::vector<cv::Mat>& featureVectors_descriptor_raw, std::vector<cv::Mat>& featureVectors_descriptor, std::vector<cv::Mat>& featureVectors_detector_logits, std::vector<cv::Mat>& featureVectors_detector, std::vector<cv::Mat>& featureVectors_segmentation) {
    ...
    if (m_prevBatchSize != inputFaceChips.size()) {
        ...
        Dims4 outputDims_descriptor_raw{ batchSize, outputL_descriptor_raw.d[1], outputL_descriptor_raw.d[2], outputL_descriptor_raw.d[3] };
        Dims4 outputDims_descriptor{batchSize, outputL_descriptor.d[1], outputL_descriptor.d[2], outputL_descriptor.d[3] };
        Dims4 outputDims_detector_logits{ batchSize, outputL_detector_logits.d[1], outputL_detector_logits.d[2], outputL_detector_logits.d[3] };
        Dims3 outputDims_detector{ batchSize, outputL_detector.d[1], outputL_detector.d[2] };
    ...
    std::vector<void*> predictionBindings = {m_inputBuff.deviceBuffer.data(), m_outputBuff_segmentation.deviceBuffer.data(), m_outputBuff_detector_logits.deviceBuffer.data(),m_outputBuff_detector.deviceBuffer.data(), m_outputBuff_descriptor_raw.deviceBuffer.data(),m_outputBuff_descriptor.deviceBuffer.data() };
    // Run inference.
    ...
    for (int batch = 0; batch < batchSize; ++batch) {
        int dims_descriptor_raw[] = { outputL_descriptor_raw.d[1], outputL_descriptor_raw.d[2], outputL_descriptor_raw.d[3] };
        int dims_descriptor[] = { outputL_descriptor.d[1], outputL_descriptor.d[2], outputL_descriptor.d[3] };
        int dims_detector_logits[] = { outputL_detector_logits.d[1], outputL_detector_logits.d[2], outputL_detector_logits.d[3] };
        int dims_detector[] = { outputL_detector.d[1], outputL_detector.d[2] };
